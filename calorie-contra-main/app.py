...
async def food_log():
    ...
    # if the user reached GET (as by clicking food_log)
        ...
        return await render_template(
            ...
            today_totals={
                'calories': float(today_totals.total_calories or 0),
                'protein': float(today_totals.total_protein or 0),
                'carbs': float(today_totals.total_carbs or 0),
                'fat': float(today_totals.total_fat or 0)
            }
        )
